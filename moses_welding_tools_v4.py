# Moses Welding Tools v4
# Professional Welding Calculator Suite
...
def daily_log():
    ...
    while True:
        ...
        if choice == "1":
            ...
            try:
                with open("welding_log.txt", "r") as file:
...
while True:
    print("\n==== Moses Welding Tools v4 ====")
    print("Welcome to Moses Welding Tools v4 – your all-in-one welding calculator!")
    print("\n1. Basic Welding Calculator")
    ...
    if choice == "1":
        ...
        print("\nGoodbye! Thank you for using Moses Welding Tools v4.")
        break
    else:
